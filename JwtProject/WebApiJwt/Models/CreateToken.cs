...
namespace WebApiJwt.Models
{
    public class CreateToken
    {
        ...
        public string TokenCreateAdmin()
        {
            ...
            JwtSecurityToken jwtSecurityToken = new JwtSecurityToken(issuer: "http://localhost", audience: "http://localhost", notBefore: DateTime.Now, expires: DateTime.Now.AddSeconds(59), signingCredentials: credentials, claims: claims);
